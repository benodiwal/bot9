...
const ChatWindow: FC<{
  ...
  return (
    <div className="relative flex w-full flex-col items-center gap-4 rounded-sm border">
      <div className="bg-gray-100 absolute left-0 top-0 z-10 w-full rounded-sm p-4 text-center text-gray-500">
        Bot9Ai
      </div>
      ...
      <form
        className="bg-gray-100 absolute bottom-0 flex w-full items-center justify-center gap-4 p-4"
        onSubmit={(e) => {
          e.preventDefault();
          if (input.trim()) {
